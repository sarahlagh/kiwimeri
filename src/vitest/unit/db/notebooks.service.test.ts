...
describe('notebooks service', () => {
  ...
  it(`should update notebook title`, () => {
    ...
    expect(collectionService.getItemField(n1, 'title')).toBe('non default title');
  ...
  it(`should create items inside current notebook`, () => {
    ...
    expect(collectionService.getItemField(id0, 'notebook')).not.toBe(ROOT_NOTEBOOK);
    expect(collectionService.getItemField(id0, 'notebook')).toBe(notebooksService.getCurrentNotebook());
