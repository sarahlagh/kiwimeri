...
import { defaultOptions, SearchOptions } from './types';

const REPLACED_CHARS = /[\n\u00a0]/g;
const LB = ' '; // replace line breaks by space for searching

class CollectionLexicalSearchService {
  ...
  public searchEditorState(
    ...
    if (!searchService.acceptsSearchText(searchText)) return;
...
export const searchLexicalService = new CollectionLexicalSearchService();
